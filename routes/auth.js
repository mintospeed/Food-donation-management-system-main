...
router.get("/auth/logout", (req,res) => {
	req.logout(function(err) {
		if (err) {
			return next(err); // Pass the error to the next middleware if something goes wrong.
		}
		// If logout is successful, redirect or handle it accordingly.
		res.redirect('/login'); // Or any other route you want to redirect to after logging out.
	});
